...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Wl(){return new Ie({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:go(),fragmentShader:`
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Xl(){return new Ie({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:go(),fragmentShader:`
...
`)}function jf(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function rs(i){return i!==""}function nc(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function ic(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var tp=/^[ \t]*#include +<([\w\d./]+)>/gm;function ho(i){return i.replace(tp,np)}var ep=new Map;function np(i,t){let e=Pt[t];if(e===void 0){let n=ep.get(t);if(n!==void 0)e=Pt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ho(e)}var ip=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sc(i){return i.replace(ip,sp)}function sp(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function rc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function rp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Da?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Yo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Ke&&(t="SHADOWMAP_TYPE_VSM"),t}function ap(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Zn:case Jn:t="ENVMAP_TYPE_CUBE";break;case Ki:t="ENVMAP_TYPE_CUBE_UV";break}return t}function op(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Jn:t="ENVMAP_MODE_REFRACTION";break}return t}function lp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Fa:t="ENVMAP_BLENDING_MULTIPLY";break;case dl:t="ENVMAP_BLENDING_MIX";break;case fl:t="ENVMAP_BLENDING_ADD";break}return t}function cp(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function hp(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,l=rp(e),c=ap(e),h=op(e),u=lp(e),f=cp(e),m=Kf(e),x=Qf(r),y=s.createProgram(),p,d,A=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(rs).join(`
`)),a=ho(a),a=nc(a,e),a=ic(a,e),o=ho(o),o=nc(o,e),o=ic(o,e),a=sc(a),o=sc(o),e.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+d);let E=A+p+a,b=A+d+o,D=jl(s,s.VERTEX_SHADER,E),w=jl(s,s.FRAGMENT_SHADER,b);s.attachShader(y,D),s.attachShader(y,w),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function C(R){if(i.debug.checkShaderErrors){let q=s.getProgramInfoLog(y).trim(),z=s.getShaderInfoLog(D).trim(),W=s.getShaderInfoLog(w).trim(),$=!0,H=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,D,w);else{let j=ec(s,D,"vertex"),V=ec(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        }`}),this.geo=e,this.mesh=new Te(e,this.mat),this.mesh.frustumCulled=!1,this.scene.add(this.mesh)}rebuild(){let t=this.config,e=t.fit,n=u=>{let f=Math.sin(u*78.233)*43758.5453;return f-Math.floor(f)},s=t.cloud.radius,r=t.cloud.shell;this.mat.uniforms.uStartDot.value=t.start.dot;let a=0;pc.forEach((u,f)=>{var y;let m=new zt(u.fill),x=(y=Np[u.fill.toUpperCase()])!=null?y:(f/Math.max(1,pc.length-1)-.5)*.4;for(let p of u.pts){if(a>=this.MAX)break;let d=p[0],A=p[1],E=p[2],b=p[3],D=p[4];this.aFinal.array[a*3]=d,this.aFinal.array[a*3+1]=A,this.aFinal.array[a*3+2]=x,this.aSize.array[a*2]=E,this.aSize.array[a*2+1]=b,this.aColor.array[a*3]=m.r,this.aColor.array[a*3+1]=m.g,this.aColor.array[a*3+2]=m.b,this.aShape.array[a]=D,this.aSeed.array[a]=n(a+1);let w=n(a*1.7)*2-1,C=n(a*3.31)*Math.PI*2,U=Math.sqrt(1-w*w),M=s*(r+(1-r)*Math.cbrt(n(a*5.13)));this.aStart.array[a*3]=U*Math.cos(C)*M,this.aStart.array[a*3+1]=U*Math.sin(C)*M,this.aStart.array[a*3+2]=w*M,this.aGridDelay.array[a]=n(a+1);let v=Math.min(1,Math.hypot(d,A)/e);this.aDelay.array[a]=t.timeline.asmOrder==="radial"?v:t.timeline.asmOrder==="random"?n(a+2):w*.5+.5,a++}}),this.active=a;let o=t.merge.dist**2,l=this.aFinal.array,c=this.aColor.array,h=this.aNbr.array;for(let u=0;u<a;u++){let f=l[u*3],m=l[u*3+1],x=c[u*3],y=c[u*3+1],p=c[u*3+2],d=0,A=0,E=1e9;for(let D=0;D<a;D++){if(D===u||Math.abs(c[D*3]-x)>.01||Math.abs(c[D*3+1]-y)>.01||Math.abs(c[D*3+2]-p)>.01)continue;let w=l[D*3]-f,C=l[D*3+1]-m,U=w*w+C*C;U<E&&(E=U,d=w,A=C)}let b=E<=o;h[u*2]=b?d:0,h[u*2+1]=b?A:0}[this.aFinal,this.aStart,this.aSize,this.aColor,this.aShape,this.aSeed,this.aDelay,this.aGridDelay,this.aNbr].forEach(u=>u.needsUpdate=!0),this.geo.instanceCount=a}replay(){this._t0=this._clock?this._clock.getElapsedTime():0,this._spin=0,this.mesh.rotation.set(0,0,0)}destroy(){cancelAnimationFrame(this._raf),removeEventListener("resize",this._onResize),this._io&&this._io.disconnect(),this.renderer.dispose(),this.renderer.domElement.remove()}_loop(){if(this._raf=requestAnimationFrame(this._loop),!this._visible){this._lastT=this._clock.getElapsedTime();return}let t=this._clock.getElapsedTime(),e=Math.min(.05,t-this._lastT);this._lastT=t;let n=this.config,s=this.mat.uniforms;s.uTime.value=t;let r=this.reduced?1e6:t-this._t0,a=n.timeline,o=Math.min(1,r/Math.max(.01,a.revealDur)),l=Math.min(1,Math.max(0,(r-a.revealDur-a.hold)/Math.max(.01,a.assembleDur)));s.uReveal.value=o,s.uAssemble.value=l,s.uRevWindow.value=a.revWindow,s.uAsmWindow.value=a.asmWindow,s.uEase.value=a.easeMode,s.uRevealEase.value=a.revealEaseMode,s.uArc.value=n.flow.arc,s.uFlowScale.value=n.flow.scale,s.uCloudDrift.value=n.cloudDrift,s.uIdle.value=n.idleDrift,s.uMerge.value=n.merge.amount,s.uMergeSpeed.value=n.merge.speed,s.uWarpAmp.value=n.warp.amount,s.uWarpFreq.value=n.warp.freq,s.uWarpSpeed.value=n.warp.speed,s.uNear.value=n.depth.near,s.uFar.value=n.depth.far,s.uFog.value=n.depth.fog;let c=(mc[n.timeline.easeMode]||mc[2])(l);l<.995&&(this._spin+=e*n.spin.speed);let h=1-c;this.mesh.rotation.y=this._spin*h,this.mesh.rotation.x=n.spin.tilt*h*(.4+.6*Math.sin(t*.3)),this.renderer.render(this.scene,this.camera)}};var _c=_o;var as={startFactor:.4,ease:"power3.out",headEase:"power4.out",headStagger:.018};function xo(i=document){let t=i.querySelector("[data-shapefield]");if(!t||t.__shapefield)return;let e={},n=t.getAttribute("data-shapefield-config");if(n)try{e=JSON.parse(n)}catch(r){console.warn("[modernvivo] invalid data-shapefield-config JSON",r)}let s=new _c(t,e);return t.__shapefield=s,Op(i,s),s}function Op(i=document,t=null){if(typeof gsap=="undefined")return;let e=i.querySelector('[data-hero-reveal="title"]'),n=i.querySelectorAll('[data-hero-reveal="item"]'),s=t&&t.config&&t.config.timeline||{revealDur:1.8,hold:.35,assembleDur:2.8},r=s.revealDur+s.hold+s.assembleDur*as.startFactor,a=gsap.timeline({defaults:{ease:as.ease,duration:1},delay:r});if(e){let o=null;try{typeof SplitText!="undefined"&&(gsap.registerPlugin(SplitText),o=new SplitText(e,{type:"chars,words"}))}catch{o=null}o?a.from(o.chars,{yPercent:110,autoAlpha:0,stagger:as.headStagger,duration:.9,ease:as.headEase},0):a.from(e,{yPercent:25,autoAlpha:0,duration:1,ease:as.headEase},0)}return n.length&&a.from(n,{y:22,autoAlpha:0,stagger:.1},e?.3:0),a}gsap.registerPlugin(CustomEase,ScrollTrigger,SplitText);history.scrollRestoration="manual";var ze=null,Dn=document,xc=!1,Zr=typeof window.Lenis!="undefined",Jr=typeof window.ScrollTrigger!="undefined",ii=window.matchMedia("(prefers-reduced-motion: reduce)"),$r=ii.matches,yc;(yc=ii.addEventListener)==null||yc.call(ii,"change",i=>$r=i.matches);var Mc;(Mc=ii.addListener)==null||Mc.call(ii,i=>$r=i.matches);var nn=i=>!!Dn.querySelector(i);var Bp=.6;CustomEase.create("osmo","0.625, 0.05, 0, 1");gsap.defaults({ease:"osmo",duration:Bp});function zp(){qp(),!xc&&(xc=!0,nn("[data-shapefield]")&&xo(document),nn("[data-button-056]")&&jr(document),nn("[data-reveal]")&&ta(document),nn("[data-reveal-group]")&&na(document),nn("[data-stacking-cards-item]")&&ea(document))}function kp(i){Dn=i||document}function Vp(i){Dn=i||document,nn("[data-shapefield]")&&xo(Dn),nn("[data-button-056]")&&jr(Dn),nn("[data-reveal]")&&ta(Dn),nn("[data-reveal-group]")&&na(Dn),nn("[data-stacking-cards-item]")&&ea(Dn),Zr&&ze.resize(),Jr&&ScrollTrigger.refresh()}function Hp(i){let t=gsap.timeline();return t.call(()=>{vo(i)},null,0),t}function Gp(i,t){let e=gsap.timeline({onComplete:()=>{i.remove()}});return $r?e.set(i,{autoAlpha:0}):(e.to(i,{autoAlpha:0,ease:"power1.in",duration:.5},0),e)}function Wp(i){let t=gsap.timeline();return $r?(t.set(i,{autoAlpha:1}),t.add("pageReady"),t.call(vo,[i],"pageReady"),new Promise(e=>t.call(e,null,"pageReady"))):(t.add("startEnter",0),t.fromTo(i,{autoAlpha:0},{autoAlpha:1,ease:"power1.inOut",duration:.75},"startEnter"),t.fromTo(i.querySelector("h1"),{yPercent:25,autoAlpha:0},{yPercent:0,autoAlpha:1,ease:"expo.out",duration:1},"< 0.3"),t.add("pageReady"),t.call(vo,[i],"pageReady"),new Promise(e=>{t.call(e,null,"pageReady")}))}barba.hooks.beforeEnter(i=>{gsap.set(i.next.container,{position:"fixed",top:0,left:0,right:0}),ze&&typeof ze.stop=="function"&&ze.stop(),kp(i.next.container),Xp(i.next.container)});barba.hooks.afterLeave(()=>{Jr&&ScrollTrigger.getAll().forEach(i=>i.kill())});barba.hooks.enter(i=>{Yp(i)});barba.hooks.afterEnter(i=>{Vp(i.next.container),Zr&&(ze.resize(),ze.start()),Jr&&ScrollTrigger.refresh()});barba.init({debug:!0,timeout:7e3,preventRunning:!0,transitions:[{name:"default",sync:!0,async once(i){return zp(),Hp(i.next.container)},async leave(i){return Gp(i.current.container,i.next.container)},async enter(i){return Wp(i.next.container)}}]});var vc={light:{nav:"dark",transition:"light"},dark:{nav:"light",transition:"dark"}};function Xp(i){var r;let t=((r=i==null?void 0:i.dataset)==null?void 0:r.pageTheme)||"light",e=vc[t]||vc.light;document.body.dataset.pageTheme=t;let n=document.querySelector("[data-theme-transition]");n&&(n.dataset.themeTransition=e.transition);let s=document.querySelector("[data-theme-nav]");s&&(s.dataset.themeNav=e.nav)}function qp(){ze||Zr&&(ze=new Lenis({lerp:.165,wheelMultiplier:1.25}),Jr&&ze.on("scroll",ScrollTrigger.update),gsap.ticker.add(i=>{ze.raf(i*1e3)}),gsap.ticker.lagSmoothing(0))}function vo(i){window.scrollTo(0,0),gsap.set(i,{clearProps:"position,top,left,right"}),Zr&&(ze.resize(),ze.start())}function Yp(i){var t=document.createElement("template");t.innerHTML=i.next.html.trim();var e=t.content.querySelectorAll("[data-barba-update]"),n=document.querySelectorAll("nav [data-barba-update]");n.forEach(function(s,r){var a=e[r];if(a){var o=a.getAttribute("aria-current");o!==null?s.setAttribute("aria-current",o):s.removeAttribute("aria-current");var l=a.getAttribute("class")||"";s.setAttribute("class",l)}})}})();
